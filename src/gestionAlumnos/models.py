...
class Alumno(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'C - Inscripcion'
...
class Concepto(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'concepto'
        verbose_name_plural = 'H - Concepto'
...
class Configuracion(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'I - Configuracion'
...
class Curso(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'E - Carga de Talleres'
...
class Idioma(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'F - Carga de Cursos'
...
class Inscripcion(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'J - Inscripcion Masiva de Alumnos'
...
class ModificarInscripcion(models.Model):
    ...
    class Meta:
        managed = False            
        verbose_name_plural = 'K - Modificar Cuotas Pagadas' 

class ModificarInscripcionSocio(models.Model):
    pass

    class Meta:
        managed = False            
        verbose_name_plural = 'L - Modificar Cuotas Socios Pagadas'         
...
class PagoInscCuotaSocio(models.Model):    
    id_pago_insc_cuota_soc = models.AutoField(primary_key=True)
    ...
    def save(self, *args, **kwargs):       
        self.usuario = str(get_username())
        super(PagoInscCuotaSocio, self).save(*args, **kwargs)
    class Meta:
        verbose_name = 'Abono de Cuota Socio'
        verbose_name_plural = 'B - Abono de Cuota Socio'
        managed = False
        db_table = 'pago_insc_cuota_socio'
        unique_together = (('id_pago_insc_cuota_soc', 'fecha_alta'))
...
class PeriodoCurso(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'D - Talleres'
