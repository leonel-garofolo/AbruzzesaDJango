...
function getCuotas() {
	...
	$.ajax({
		type : "POST",
		url : '/admin/function/get_cuotas_pagas',
		data : {
...
function getImporte(){
	...
	if(idCuota != null){
		$.ajax({
			type : "POST",
			url : '/admin/function/get_importe_inscripcion_pagado',
			data : {
				cbxCuota : $("#cbxCuota").val()
			},
			success : function(json) {
				$.each(json, function(i, value) {				
					var options = '';
...
function update(){	
	...
	$.ajax({
		type : "POST",
		url : '/admin/function/update_insc_cuota',
		data : {		
			cbxCuota : $("#cbxCuota").val(),
...
function deleteCuota(){		
	$.ajax({
		type : "POST",
		url : '/admin/function/delete_insc_cuota',
		data : {
			cbxCuota : $("#cbxCuota").val()
		},
		success : function(response) {	
...
function printTicket(){	
	$('#pdf-iframe').attr("src", '/admin/function/ticket?id_pago_insc_cuota=' + $('#cbxCuota').val()).load(function(){
